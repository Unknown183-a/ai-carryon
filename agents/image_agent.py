...
def generate_image_prompts(topic, script, num_images=4):
    ...
    for finding relevant stock photos on a photo search engine. Keywords should describe
    visual, tech-related scenes (e.g. "coding laptop screen", "data server room", "AI robot hand").
