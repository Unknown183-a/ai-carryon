...
- Background: dark futuristic studio, glowing orange holographic UI flickering
...
- Lighting: dark studio with saffron ambient, holographic screen glow on face
- Action: he gestures at large floating holographic data/visuals related to the topic
- Background: holographic elements animate and pulse around him in orange/saffron glow
...
- Lighting: premium soft orange/saffron rim light, slightly warmer tone
- Action: he looks directly into camera, gestures as if recommending to viewer
- Background: holographic text floats in foreground, dark background with subtle saffron glow
