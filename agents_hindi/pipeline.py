...
def step_images(inputs: dict) -> dict:
    from agents.image_agent import generate_backgrounds  # Reuse English image agent
    print("🌆 Dark tech images fetch ho rahi hain...")
...
def step_voice(inputs: dict) -> dict:
    ...
    print("🎙️  Hindi awaaz generate ho rahi hai...")
    inputs["voice"] = generate_voice(inputs["script"])
    return inputs

def step_captions(inputs: dict) -> dict:
    from agents.caption_agent import create_srt  # Reuse English caption agent
    print("💬 Captions ban rahe hain...")
    inputs["captions"] = create_srt(inputs["script"], inputs["voice"])
    return inputs

def step_video(inputs: dict) -> dict:
    from agents.video_agent import create_video  # Reuse English video agent
...
def step_upload_youtube(inputs: dict) -> dict:
    ...
    print(f"✅ YouTube par upload hua: {video_url}")
    return inputs
